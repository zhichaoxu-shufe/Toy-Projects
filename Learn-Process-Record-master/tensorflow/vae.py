...
test_dataset = tf.data.Dataset.from_tensor_slices(test_images).shuffle(TEST_BF).batch(BATCH_SIZE)
...
class CVAE(tf.keras.Model):
    def __init__(self, latent_dim):
        ...
        self.inference_dim = tf.keras.Sequential(
            [
    ...
    def reparaterize(selfself, mean, logvar):
