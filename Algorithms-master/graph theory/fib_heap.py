# fibonacci heaps
# using fibonacci for priority queue improves the asymptotic running time of 
# import algorithms, such as Dijkstra's algorithm for computing the shortest
# path between two nodes in a graph, compared to the same algorithm using
# other slower priority queue data structures
...
class FibonacciHeap:
    ...
    # if a child node becomes smaller than its parent node we cut
    # this child node off and bring it up to the root list
    def cut(self, x, y):
    ...
    def consolidate(self):
        ...
        # because root list was iterately changing as we were moving
    ...
    # remove a node from the odubly linked child list
